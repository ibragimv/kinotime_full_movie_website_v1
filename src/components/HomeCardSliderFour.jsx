...
const HomeCardSliderFour = () => {
  ...
  useEffect(() => {
    const fetchRandomMovies = async () => {
      try {
        const res = await fetch('https://api.kinotime.world/api/genres/5');
    ...
    <div className="slider-container-1">
      <div className="slider-header">
        <h1 className="slider-title">
          <BiGridAlt size={28} /> DETEKTIV FILMLAR
        </h1>
...
export default HomeCardSliderFour;
